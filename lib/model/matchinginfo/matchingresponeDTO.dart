class MatchingResponseDTO {
  ...
  @override
  String toString() {
    return 'MatchingResponseDTO{id: $id, startDate: $startDate, endDate: $endDate, title: $title, contents: $contents, travelExpenses: $travelExpenses, numOfPeoples: $numOfPeoples, isAccommodationTogether: $isAccommodationTogether, isDiningTogether: $isDiningTogether, mainTravelSpace: $mainTravelSpace}';
  }
}
